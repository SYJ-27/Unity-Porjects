...
public class UiController : MonoBehaviour
{
    ...
    void Update()
    {
        UpdateLevelUI(PlayerPrefs.GetInt("Level Current"));
    }
    ...
    public void GameLosingUI(float timeEndOver, int levelOve, string reasonDied)
    {
        gameOver.GameOverScene(timeEndOver, levelOve, reasonDied);
    }

    public void GameWinUI(float timeEndWin, int levelWin)
    {
        gameOver.GameWinScene(timeEndWin, levelWin);
    }

    public void PlusTimeUI(int time, Text plusTime)
    {
