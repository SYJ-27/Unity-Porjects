...
{
    public Text scoreText, highScoreText, scoreBeanText, scoreTimeText;
    public GameObject replayButton, gameOverObj, scoreObj, highScoreObj, beanObj, timeObj;
    void Awake(){
    ...
    public void GameOverScene(){
        ...
        gameOverObj.transform.DOScale(Vector3.one, 0.5f).OnComplete(()=>{
            scoreObj.transform.DOScale(Vector3.one, 0.4f).OnComplete(()=>{
                highScoreObj.transform.DOScale(Vector3.one, 0.4f).OnComplete(()=>{
